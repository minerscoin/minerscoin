 ...
 * Public-key-hash-addresses have version 0 (or 73 testnet).
 * The data vector contains RIPEMD160(SHA256(pubkey)), where pubkey is the serialized public key.
 * Script-hash-addresses have version 5 (or 85 testnet).
...
public:
    enum
    {
        PUBKEY_ADDRESS = 50, // MinersCoin addresses start with X
        SCRIPT_ADDRESS = 110,
        PUBKEY_ADDRESS_TEST = 73,
